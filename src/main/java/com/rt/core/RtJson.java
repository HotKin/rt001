...
public class RtJson extends Json {
	...
	public static void setDefaultConvertDepth(int defaultConvertDepth) {
		...
		RtJson.defaultConvertDepth = defaultConvertDepth;
	}
	
	public RtJson setConvertDepth(int convertDepth) {
		if (convertDepth < 2) {
	...
	public RtJson setTimestampPattern(String timestampPattern) {
