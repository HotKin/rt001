...
import com.rt.core.kit.PathKit;
...
public class FileUtils {
	...
	public static String readString(File file) {
		...
		try {
			...
			return new String(baos.toByteArray(), RT.me().getConstants().getEncoding());
		} catch (Exception e) {
		} finally {
			close(fis, baos);
		}
	...
	public static void writeString(File file, String string) {
		...
		try {
			...
			fos.write(string.getBytes(RT.me().getConstants().getEncoding()));
		} catch (Exception e) {
		} finally {
			close(null, fos);
		}
